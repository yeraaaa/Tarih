const khansData = [
  ...
  { name: 'Kasym Khan', reign: '1511 – 1523', description: 'Kasym Khan is celebrated for significantly expanding the territory of the Kazakh Khanate. His military campaigns and strategic alliances increased the Khanate’s influence and territorial control, making it a major power in Central Asia during his reign.', photo: 'url_to_kasym_khan_photo' },
  ...
  { name: 'Haq Nazar Khan', reign: '1538 – 1580', description: 'Haq Nazar Khan is credited with rebuilding the Kazakh Khanate after a period of internal strife. His reign was characterized by efforts to restore order, consolidate power, and strengthen the Khanate’s position among its neighbors.', photo: 'url_to_haq_nazar_khan_photo' },
  ...
  { name: 'Esim Khan', reign: '1598 – 1628', description: 'Esim Khan’s reign was a period of stabilization and consolidation for the Kazakh Khanate. He strengthened the Khanate’s internal structures and power, ensuring its continued existence and resilience against external threats.', photo: 'url_to_esim_khan_photo' },
  ...
  { name: 'Abylai Khan', reign: '1771 – 1781', description: 'Abylai Khan is celebrated for unifying the Kazakh tribes and strengthening the Khanate. His diplomatic and military skills enabled the Khanate to navigate a complex political landscape and emerge as a strong, unified entity.', photo: 'url_to_abylai_khan_photo' },
